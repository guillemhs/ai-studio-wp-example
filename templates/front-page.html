...
<!-- wp:main -->
  ...
  <div class="wp-block-group alignfull has-background" style="background-color:#01003f;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-center">
      ...
      <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
        ...
        <h1 class="wp-block-heading has-white-color has-text-color" style="font-size:4rem;line-height:1.1">Hacemos el trabajo más <span style="color:#00B2E9">Humano</span> y Eficiente</h1>
        <!-- /wp:heading -->
        ...
        <p class="has-white-color has-text-color" style="font-size:1.5rem">Ayudamos a personas y organizaciones a mejorar sus formas de trabajar mediante innovación, calidad y talento humano.</p>
        <!-- /wp:paragraph -->

        <!-- wp:buttons -->
        <div class="wp-block-buttons">
          <!-- wp:button {"backgroundColor":"agile-vibrant","textColor":"white"} -->
          <div class="wp-block-button"><a class="wp-block-button__link has-white-color has-agile-vibrant-background-color has-text-color has-background wp-element-button">Nuestros Servicios</a></div>
          <!-- /wp:button -->

          <!-- wp:button {"className":"is-style-outline","style":{"color":{"text":"#ffffff"}}} -->
          <div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-text-color wp-element-button" style="color:#ffffff">Contáctanos</a></div>
          <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
      </div>
        ...
        <div class="wp-block-group has-background" style="background-color:#0a192fcc;border-radius:12px;border-color:#ffffff20;border-width:1px;border-style:solid;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">
            ...
            <div class="wp-block-group has-background" style="background-color:#020c1b;border-bottom-color:#ffffff0d;border-bottom-width:1px;padding-top:1rem;padding-right:1.5rem;padding-bottom:1rem;padding-left:1.5rem">
                ...
                <div class="wp-block-group">
                    ...
                    <div class="wp-block-group has-vivid-red-background-color has-background" style="border-radius:99px;min-height:12px;min-width:12px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"></div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-group has-luminous-vivid-amber-background-color has-background" style="border-radius:99px;min-height:12px;min-width:12px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"></div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-group has-pale-cyan-blue-background-color has-background" style="border-radius:99px;min-height:12px;min-width:12px;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"></div>
                    <!-- /wp:group -->
                </div>
                <!-- /wp:group -->

                <!-- wp:paragraph {"style":{"typography":{"fontFamily":"monospace","fontSize":"0.875rem"}},"textColor":"gray-400"} -->
                <p class="has-text-color" style="color:#9ca3af;font-family:monospace;font-size:0.875rem">user@agile611:~/events</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
            ...
            <div class="wp-block-group" style="padding-top:1.5rem;padding-right:1.5rem;padding-bottom:1.5rem;padding-left:1.5rem">
                ...
                <p class="has-agile-vibrant-color has-text-color" style="font-family:monospace;font-size:1rem;font-weight:600"><span style="color:#499497">$</span> list --upcoming --events</p>
                <!-- /wp:paragraph -->
  ...
  <div class="wp-block-group alignfull has-background" style="background-color:#F5F5F5;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
    ...
    <h2 class="wp-block-heading has-text-align-center has-agile-deep-color has-text-color" style="font-size:3rem">Soluciones Integrales</h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"1.35rem"}},"textColor":"agile-text"} -->
    <p class="has-text-align-center has-agile-text-color has-text-color" style="font-size:1.35rem">Combinamos experiencia técnica y metodológica para impulsar el crecimiento.</p>
    <!-- /wp:paragraph -->
  ...
  <div class="wp-block-group alignfull has-background" style="background-color:#ffffff;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
    ...
    <div class="wp-block-columns alignwide">
      ...
      <div class="wp-block-column is-vertically-aligned-center">
        ...
        <h2 class="wp-block-heading has-agile-deep-color has-text-color" style="font-size:3rem">El equilibrio entre <span style="color:#057EB5">Tecnología</span> y <span style="color:#4CB8C9">Humanidad</span></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"style":{"typography":{"fontSize":"1.25rem"}}} -->
        <p style="font-size:1.25rem">En Agile611, creemos que la transformación digital no es solo sobre herramientas, sino sobre cultura.</p>
        <!-- /wp:paragraph -->
      ...
      <div class="wp-block-column is-vertically-aligned-center">
        ...
        <figure class="wp-block-image size-large is-style-rounded"><img src="https://picsum.photos/800/600?grayscale" alt="Team Collaboration"/></figure>
        <!-- /wp:image -->
      </div>
      <!-- /wp:column -->
    </div>
